...
This file is part of obdgpslogger (with a couple of additions from me).
...
float obdConvert_53    (unsigned int A, unsigned int B, unsigned int C, unsigned int D) {
    return (((float)A*256.0f)+(float)B)/200.0f;
}


float obdConvert_54    (unsigned int A, unsigned int B, unsigned int C, unsigned int D) {
    return (((float)A*256.0f)+(float)B)-32767.0f;
}


float obdConvert_59    (unsigned int A, unsigned int B, unsigned int C, unsigned int D) {
    return (((float)A*256.0f)+(float)B) * 10.0f;
}


float obdConvert_5D    (unsigned int A, unsigned int B, unsigned int C, unsigned int D) {
    return ((((float)A*256.0f)+(float)B)-26880.0f)/128.0f;
}


float obdConvert_5E    (unsigned int A, unsigned int B, unsigned int C, unsigned int D) {
    return (((float)A*256.0f)+(float)B)*0.05f;
}


float obdConvert_61    (unsigned int A, unsigned int B, unsigned int C, unsigned int D) {
