...
const static struct obdservicecmd obdcmds_mode1[] = {
	...
	{ 0x05, 1, "temp",          "Engine Coolant" , -40, 215, "*C", obdConvert_05 }, // J1979 calls this "ect"
	...
	{ 0x0A, 1, "frp",           "Fuel Rail Pres.", -100, 99.22, "%", obdConvert_0A },
	...
	{ 0x0E, 1, "sparkadv",      "Cyl1 timing Adv", -64, 63.5, "deg", obdConvert_0E },
	{ 0x0F, 1, "iat",           "Intake Air Temp", -40, 215, "*C", obdConvert_0F },
	{ 0x10, 2, "maf",           "Mass Air Flow", 0, 655.35, "g/s", obdConvert_10 },
	{ 0x11, 1, "throttlepos",   "Abs Throt. Pos", 1, 100, "%", obdConvert_11 },
	{ 0x12, 1, "air_stat",      "Commded Sec Air" , 0, 0, "Bit Encoded", NULL },
	...
	{ 0x2E, 1, "evap_pct",      "Commd Evap Purge", 0, 100, "%", obdConvert_2E },
	{ 0x2F, 1, "fli",           "Fuel Level Input", 0, 100, "%", obdConvert_2F },
	{ 0x30, 1, "warm_ups",      "warmups w/o DTCs", 0, 255, "", obdConvert_30 },
	{ 0x31, 2, "clr_dist",      "Dist. w/o DTCs", 0, 65535, "km", obdConvert_31 },
	{ 0x32, 2, "evap_vp",       "Evap Sys Vap P", -8192, 8192, "Pa", obdConvert_32 },
	{ 0x33, 1, "baro",          "Barometric Pres", 0, 255, "kPa", obdConvert_33 },
	...
	{ 0x42, 2, "vpwr",          "Cntrl mod volts", 0, 65535, "V", obdConvert_42 },
	{ 0x43, 2, "load_abs",      "Abs. Load Value", 0, 25700, "%", obdConvert_43 },
	{ 0x44, 2, "lambda",        "Fuel/air Ratio", 0, 2, "(ratio)", obdConvert_44 },
	{ 0x45, 1, "tp_r",          "Rel Throttle", 0, 100, "%", obdConvert_45 },
	{ 0x46, 1, "aat",           "Ambient air", -40, 215, "Celsius", obdConvert_46 },
	{ 0x47, 1, "tp_b",          "Abs. Throttle B", 0, 100, "%", obdConvert_47_4B },
	{ 0x48, 1, "tp_c",          "Abs. Throttle C", 0, 100, "%", obdConvert_47_4B },
	{ 0x49, 1, "app_d",         "Accel Pedal D", 0, 100, "%", obdConvert_47_4B },
	{ 0x4A, 1, "app_e",         "Accel Pedal E", 0, 100, "%", obdConvert_47_4B },
	{ 0x4B, 1, "app_f",         "Accel Pedal F", 0, 100, "%", obdConvert_47_4B },
	{ 0x4C, 1, "tac_pct",       "Commd Thrt Act", 0, 100, "%", obdConvert_4C },
	...
	{ 0x5D, 2, "fuel_timing",   "Injec Timing", -310, 301.992, "deg", obdConvert_5D },
	...
	{ 0x61, 1, "tq_dd",         "Driver's Demand Engine - Percent Torque" , -125, 130, "%", obdConvert_61 },
